...
Вызываем vi и создаем файл hello.sh. Для того, чтобы результат проделанной работы можно было увидеть создаю это в каталоге, который подключен к репозиторию и где будет находится данный отчет.

![Задание 1.3](image/1.png){width=70%}

Нажимаем кнопку i, чтобы вставить необходимый текст и переходим в командный режим с помощью кнопки Esc.

![Задание 1.4](image/2.png){width=70%}

В командном режиме вводим команду :wq и сохраняем созданный файл.

![Задание 1.7](image/3.png){width=70%}

В терминале делаем созданный файл исполняемым.

![Задание 1.8](image/4.png){width=70%}

Открываем созданный файл в редакторе vi.

![Задание 2.1](image/5.png){width=70%}

Устанавливаем курсор в конце слова HELL и меняем его на HELLO.
...
Вставляем в конец нужную строку.

![Задание 2.6](image/9.png){width=70%}

Переходим в командный режим и удаляем ее.

![Задание 2.7-2.8](image/10.png){width=70%}

Вводим команду :u, чтобы отменить последнее действие удаления строки.

![Задание 2.9](image/11.png){width=70%}

Снова сохраняем файл и выходим командой :wq.
...
7. Перейти в режим вставки, команда ni -- вставить символ n раз.
...
13. Ввод данных с помощью режима вставки -> Редактирование файла с помощью командного режима -> Сохранение файла с помощью последней строки.
