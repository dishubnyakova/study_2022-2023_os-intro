...
![Исполнение в терминале](image/2.png){width=70%}
...
![Исполнение в терминале](image/4.png){width=70%}

Командный файл — аналог команды ls (без использования самой этой ко-
манды и команды dir). Требуется, чтобы он выдавал информацию о нужном каталоге
и выводил информацию о возможностях доступа к файлам этого каталога

![Программа](image/5.png){width=70%}

![Исполнение в терминале](image/6.png){width=70%}
...
![Исполнение в терминале](image/8.png){width=70%}
...
5. ! !ехр Если ехр равно 0, то возвращает 1; иначе 0
...
8. Такие символы, как ' < > * ? | \ " &, являются метасимволами и имеют для ко-
...
метасимволом.
9. Для экранирования группы метасимволов нужно заключить её в одинарные кавыч-
